...
class SkyblockProfileController(
    ...
    suspend fun getPlayer(
        ...
        return skyblockService.getProfiles(uuidService.getUUID(ign))
    }
    ...
    suspend fun getSelectedProfile(
        ...
        return skyblockService.getSelectedProfile(uuidService.getUUID(ign))
    }
    ...
    suspend fun getSelectedProfileMember(
        ...
        return skyblockService.getSelectedProfileMember(uuidService.getUUID(ign))
    }
    ...
    suspend fun getSkills(
        ...
        return skyblockService.getSkills(uuidService.getUUID(ign))
    }
}